...
export const metadata = {
  ...
  description: "People use these two terms interchangeably, but they describe different mental systems. One holds information. The other holds it while actively using it — and that distinction explains a lot about why some tasks feel so much harder than others.",
  excerpt: "People use these two terms interchangeably, but they describe different mental systems. One holds information. The other holds it while actively using it — and that distinction explains a lot about why some tasks feel so much harder than others.",
  date: "2026-08-25",
  tags: ["memory","cognitive science"],
  featuredImage: "/blog-images/1787655561733-working-memory-vs-short-term-memory.jpg",
};
