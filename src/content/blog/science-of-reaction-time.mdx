...
export const metadata = {
  ...
  description:
    "The average human reaction time to a simple visual cue is around 250 milliseconds — faster than a blink. Here's what actually shapes that number, and which of the popular tricks for improving it hold up to scrutiny.",
  excerpt:
    "The average human reaction time to a simple visual cue is around 250 milliseconds — faster than a blink. Here's what actually shapes that number, and which of the popular tricks for improving it hold up to scrutiny.",
  date: "2026-08-24",
  tags: ["reaction time"],
