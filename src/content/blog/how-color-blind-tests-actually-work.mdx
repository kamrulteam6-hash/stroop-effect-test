...
export const metadata = {
  ...
  description: "Roughly 1 in 12 men and 1 in 200 women have some degree of color vision deficiency, most of them without ever being formally diagnosed. Here's how the classic dot-pattern test actually detects it, and why red-green deficiency is so much more common than any other kind.",
  excerpt: "Roughly 1 in 12 men and 1 in 200 women have some degree of color vision deficiency, most of them without ever being formally diagnosed. Here's how the classic dot-pattern test actually detects it, and why red-green deficiency is so much more common than any other kind.",
  date: "2026-08-22",
  tags: ["color vision","vision"],
  featuredImage: "/blog-images/1787656042540-how-color-blind-tests-actually-work.jpg",
};
